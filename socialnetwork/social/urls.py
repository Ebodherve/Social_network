...
from .views import PostListView,PostDetailView,PostEditView,PostDeleteView,CommentDeleteView,ProfileView,ProfileEditView,AddFollower,RemoveFollower,AddLike,Dislike,UserSearch,ListFollowers,AddCommentLike,CommentDislike,CommentReplyView,ThreadNotification,PostNotification,FollowNotification,RemoveNotification,CreateThreadView,ListThreads,ThreadView,CreateMessage,SharedPostView,Explore
urlpatterns = [
